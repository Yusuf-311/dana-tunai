        ...
        if (input.files && input.files[0]) {
          ...
          reader.onload = function (e) {
            ...
            if (fileData.startsWith("data:image")) {
              ...
              icon.innerHTML = "";
              icon.className = "";
              icon.className = "file-drop-icon  bi bi-film";
            } else {
              icon.innerHTML = "";
              icon.className = "";
              icon.className = "file-drop-icon  bi bi-file-text";
            }
          };
    ...
    forEach(carousels, function (index, value) {
      ...
      if (pager != undefined) {
        ...
        carousel.events.on("indexChanged", function () {
          ...
          pager
            .querySelector('[data-goto="' + info.displayIndex + '"]')
      ...
      if (carouselWrapper.querySelector(".tns-carousel-progress") === null)
        return;
      var carouselInfo = carousel.getInfo(),
        carouselCurrentSlide =
          carouselWrapper.querySelector(".tns-current-slide"),
        carouselTotalSlides =
          carouselWrapper.querySelector(".tns-total-slides"),
        carouselProgress = carouselWrapper.querySelector(
          ".tns-carousel-progress .progress-bar"
        );
      carouselCurrentSlide.innerHTML = carouselInfo.displayIndex;
      carouselTotalSlides.innerHTML = carouselInfo.slideCount;
      carouselProgress.style.width =
        (carouselInfo.displayIndex / carouselInfo.slideCount) * 100 + "%";
      carousel.events.on("indexChanged", function () {
        var info = carousel.getInfo();
        carouselCurrentSlide.innerHTML = info.displayIndex;
        carouselProgress.style.width =
          (info.displayIndex / info.slideCount) * 100 + "%";
      });
    });
  })();
  /**
  ...
  var charts = (function () {
    ...
    for (var _i = 0; _i < barChart.length; _i++) {
      var _data = JSON.parse(barChart[_i].dataset.barChart),
        _options =
          barChart[_i].dataset.options != undefined
            ? JSON.parse(barChart[_i].dataset.options)
            : "",
